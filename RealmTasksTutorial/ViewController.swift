...
//        items.append(Task(value: ["text": "My First Task"]))
    ...
    func setupRealm() {
        ...
        let username = "realm-admin"  // <--- Update this
        let password = ""  // <--- Update this
    ...
    // ------ supporting moving and deleting task --------
    ...
    // ------ supporting moving and deleting task -------- (end)
    ...
    // ------ support toggling the 'completed' state of a task by tapping it -------- (end)
